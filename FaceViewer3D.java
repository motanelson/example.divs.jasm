...
public class FaceViewer3D extends JPanel {
    private List<double[][]> faces = new ArrayList<>();
    private double angle = 0;

    public FaceViewer3D(File csvFile) throws IOException {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            try {
                ...
                FaceViewer3D panel = new FaceViewer3D(chooser.getSelectedFile());
                frame.add(panel);
